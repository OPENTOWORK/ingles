...
const exercises = [
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Stubborn = alguien que no cambia de opinión fácilmente",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: Y H S",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function B1VocabularyIntermedioLevel6Page() {
