...
const exercises = [
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Sightseeing = visitar lugares turísticos",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: P A C K R E B K A C",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function B1VocabularyAvanzadoLevel4Page() {
