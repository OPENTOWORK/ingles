...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: announcement ↔ ?",
    "options": [
      "anuncio público",
      "buzón de voz",
      "charla",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Voicemail stores audio messages when you can’t answer the phone",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: T E C H A T",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function B1VocabularyAvanzadoLevel11Page() {
