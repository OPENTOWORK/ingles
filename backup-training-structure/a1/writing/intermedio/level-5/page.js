...
export default function A1WritingIntermedioLevel5Page() {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h1 style={{ color: "#2563eb", marginBottom: "0.5rem" }}>📖 Writing - Level 5</h1>
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/writing/intermedio/level-6"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
