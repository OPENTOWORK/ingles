...
const exercises = [
  {id:1,type:"matching",question:"Empareja: sun ↔ ?",options:["☀️","🌧️","❄️","💨"],correct:"☀️",explanation:"'Sun' es sol."},
  {id:2,type:"multiple-choice",question:"Completa: 'It's ___ today.'",options:["sunny","bread","table","chair"],correct:"sunny",explanation:"Está soleado hoy."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["rain","cloudy","rice","windy"],correct:"rice",explanation:"'Rice' no es clima."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Snow' = nieve",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Snow' significa nieve."},
  {id:5,type:"ordering",question:"Ordena las letras: D C U L O Y C",options:["CLOUDY","CLODUY","CUDOLY","CLOODY"],correct:"CLOUDY",explanation:"Forma 'CLOUDY'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'We need an umbrella when it ___'",options:["rains","suns","winds","snows"],correct:"rains",explanation:"Necesitamos paraguas cuando llueve."},
  {id:7,type:"multiple-choice",question:"Completa: 'It's very ___ today.'",options:["hot","rice","table","bread"],correct:"hot",explanation:"Hace mucho calor hoy."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'wether'",options:["wether → weather","wether → whether","wether → wather","wether → wheater"],correct:"wether → weather",explanation:"La forma correcta es 'weather'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'It's ___ outside!'",options:["cold","bread","socks","table"],correct:"cold",explanation:"Hace frío afuera."},
  {id:10,type:"multiple-choice",question:"Completa: 'In winter, it often ___'",options:["snows","rains","hot","sunny"],correct:"snows",explanation:"En invierno nieva."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: sun ↔ ?",
    "options": [
      "☀️",
      "🌧️",
      "❄️",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Snow” = nieve",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: D C U L O Y C",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel10Page() {
