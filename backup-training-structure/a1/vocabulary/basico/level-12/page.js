...
const exercises = [
  {id:1,type:"matching",question:"Empareja: school ↔ ?",options:["escuela","parque","supermercado","hospital"],correct:"escuela",explanation:"'School' significa escuela."},
  {id:2,type:"multiple-choice",question:"Completa: 'We study at ___'",options:["school","bed","table","chair"],correct:"school",explanation:"Estudiamos en la escuela."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["park","market","bread","hospital"],correct:"bread",explanation:"'Bread' no es un lugar."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Bank' = banco",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Bank' significa banco."},
  {id:5,type:"ordering",question:"Ordena las letras: R P A K",options:["PARK","KRAP","ARKP","RAKP"],correct:"PARK",explanation:"Forma 'PARK'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'Children play in the ___'",options:["park","bank","shop","office"],correct:"park",explanation:"Los niños juegan en el parque."},
  {id:7,type:"multiple-choice",question:"Completa: 'We buy food at the ___'",options:["supermarket","park","school","bed"],correct:"supermarket",explanation:"Compramos comida en el supermercado."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'hospitel'",options:["hospitel → hospital","hospitel → hosptal","hospitel → hospitol","hospitel → hospitel"],correct:"hospitel → hospital",explanation:"La forma correcta es 'hospital'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'Save money at the ___'",options:["bank","park","school","hospital"],correct:"bank",explanation:"Guardas dinero en el banco."},
  {id:10,type:"multiple-choice",question:"Completa: 'I'm sick. I go to the ___'",options:["hospital","park","bank","school"],correct:"hospital",explanation:"Cuando estás enfermo vas al hospital."}
];
  {
    "id": 1,
    "type": "matching",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Friday” es viernes",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: D R E B A",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel12Page() {
