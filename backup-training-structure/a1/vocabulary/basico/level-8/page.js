...
const exercises = [
  {id:1,type:"matching",question:"Empareja: dog ↔ ?",options:["🐕","🐈","🐦","🐟"],correct:"🐕",explanation:"'Dog' es perro."},
  {id:2,type:"multiple-choice",question:"Completa: 'A ___ says meow.'",options:["cat","dog","bird","fish"],correct:"cat",explanation:"Un gato dice 'miau'."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["lion","tiger","chair","elephant"],correct:"chair",explanation:"'Chair' no es animal."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Cow' = vaca",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Cow' significa vaca."},
  {id:5,type:"ordering",question:"Ordena las letras: S R H O E",options:["HORSE","HORES","SHROE","HOSER"],correct:"HORSE",explanation:"Forma 'HORSE'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'A ___ lives in water.'",options:["fish","bird","dog","cat"],correct:"fish",explanation:"Un pez vive en el agua."},
  {id:7,type:"multiple-choice",question:"Completa: 'A ___ can fly.'",options:["bird","cat","dog","fish"],correct:"bird",explanation:"Un pájaro puede volar."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'rabbet'",options:["rabbet → rabbit","rabbet → rabbat","rabbet → rabitt","rabbet → rabit"],correct:"rabbet → rabbit",explanation:"La forma correcta es 'rabbit'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'A ___ is big and gray.'",options:["elephant","rabbit","dog","cat"],correct:"elephant",explanation:"Un elefante es grande y gris."},
  {id:10,type:"multiple-choice",question:"Completa: 'A ___ gives us milk.'",options:["cow","horse","cat","dog"],correct:"cow",explanation:"Una vaca nos da leche."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: dog ↔ ?",
    "options": [
      "🐕",
      "🐈",
      "🐦",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Cow” = vaca",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: S R H O E",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel8Page() {
