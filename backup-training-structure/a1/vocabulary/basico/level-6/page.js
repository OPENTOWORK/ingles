...
const exercises = [
  {id:1,type:"matching",question:"Empareja: shirt ↔ ?",options:["camisa","zapatos","vestido","sombrero"],correct:"camisa",explanation:"'Shirt' significa camisa."},
  {id:2,type:"multiple-choice",question:"Completa: 'He's wearing a ___'",options:["shirt","chair","bread","table"],correct:"shirt",explanation:"Lleva puesta una camisa."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["jeans","skirt","table","socks"],correct:"table",explanation:"'Table' no es ropa."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Socks' = calcetines",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Socks' significa calcetines."},
  {id:5,type:"ordering",question:"Ordena las letras: O S E H S",options:["SHOES","HOSES","SHEOS","SOHES"],correct:"SHOES",explanation:"Forma 'SHOES'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'On your feet you wear ___'",options:["shoes","shirt","coat","hat"],correct:"shoes",explanation:"En los pies llevas zapatos."},
  {id:7,type:"multiple-choice",question:"Completa: 'In winter, I wear a ___'",options:["coat","T-shirt","shorts","sandals"],correct:"coat",explanation:"En invierno usas abrigo."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'skrit'",options:["skrit → skirt","skrit → shirt","skrit → skrat","skrit → skit"],correct:"skrit → skirt",explanation:"La forma correcta es 'skirt'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'A long red ___'",options:["dress","table","pants","chair"],correct:"dress",explanation:"Un vestido largo rojo."},
  {id:10,type:"multiple-choice",question:"Completa: 'My ___ are black.'",options:["shoes","skirt","shirt","dress"],correct:"shoes",explanation:"Mis zapatos son negros."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: shirt ↔ ?",
    "options": [
      "camisa",
      "zapatos",
      "vestido",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Socks” = calcetines",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: O S E H S",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel6Page() {
