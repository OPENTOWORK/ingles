...
const exercises = [
  {id:1,type:"matching",question:"Empareja: Monday ↔ ?",options:["lunes","viernes","enero","julio"],correct:"lunes",explanation:"'Monday' significa lunes."},
  {id:2,type:"multiple-choice",question:"Completa: 'Today is Monday. ___ is Tuesday.'",options:["Tomorrow","Yesterday","Next","Last"],correct:"Tomorrow",explanation:"Mañana es martes."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["March","April","Thursday","May"],correct:"Thursday",explanation:"'Thursday' es día, no mes."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Sunday' es domingo",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Sunday' significa domingo."},
  {id:5,type:"ordering",question:"Ordena las letras: D S Y U T A R D",options:["SATURDAY","STURDAY","SATUDAY","SATURADY"],correct:"SATURDAY",explanation:"Forma 'SATURDAY'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'December is a ___'",options:["month","day","color","food"],correct:"month",explanation:"December es un mes."},
  {id:7,type:"multiple-choice",question:"Completa: '___ comes after Friday.'",options:["Saturday","Monday","Sunday","Thursday"],correct:"Saturday",explanation:"Después del viernes viene sábado."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'Febrary'",options:["Febrary → February","Febrary → Febreary","Febrary → Febuary","Febrary → Febrery"],correct:"Febrary → February",explanation:"La forma correcta es 'February'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'First month of the year'",options:["January","March","April","May"],correct:"January",explanation:"Enero es el primer mes."},
  {id:10,type:"multiple-choice",question:"Completa: 'Monday, Tuesday, ___, Thursday...'",options:["Wednesday","Friday","Sunday","Saturday"],correct:"Wednesday",explanation:"Miércoles viene después de martes."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: Monday ↔ ?",
    "options": [
      "lunes",
      "viernes",
      "enero",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Sunday” es domingo",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: D S Y U T A R D",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel4Page() {
