...
const exercises = [
  {id:1,type:"matching",question:"Empareja: eat ↔ ?",options:["comer","beber","correr","dormir"],correct:"comer",explanation:"'Eat' significa comer."},
  {id:2,type:"multiple-choice",question:"Completa: 'I ___ water every day.'",options:["drink","bread","table","chair"],correct:"drink",explanation:"Bebo agua todos los días."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["run","walk","sleep","sofa"],correct:"sofa",explanation:"'Sofa' no es un verbo."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Read' = leer",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Read' significa leer."},
  {id:5,type:"ordering",question:"Ordena las letras: P E E S L",options:["SLEEP","PEESL","SLEPE","SLEP"],correct:"SLEEP",explanation:"Forma 'SLEEP'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'At night we ___'",options:["sleep","read","run","eat"],correct:"sleep",explanation:"Por la noche dormimos."},
  {id:7,type:"multiple-choice",question:"Completa: 'I ___ English at school.'",options:["study","play","eat","drink"],correct:"study",explanation:"Estudio inglés en la escuela."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'writte'",options:["writte → write","writte → wright","writte → writ","writte → written"],correct:"writte → write",explanation:"La forma correcta es 'write'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'I ___ fast.'",options:["run","sleep","eat","drink"],correct:"run",explanation:"Corro rápido."},
  {id:10,type:"multiple-choice",question:"Completa: 'We ___ to music.'",options:["listen","bread","table","chair"],correct:"listen",explanation:"Escuchamos música."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: eat ↔ ?",
    "options": [
      "comer",
      "beber",
      "correr",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Read” = leer",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: P E E S L",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel11Page() {
