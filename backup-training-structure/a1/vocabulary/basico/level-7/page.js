...
const exercises = [
  {id:1,type:"matching",question:"Empareja: bed ↔ ?",options:["cama","mesa","silla","cocina"],correct:"cama",explanation:"'Bed' significa cama."},
  {id:2,type:"multiple-choice",question:"Completa: 'The food is in the ___'",options:["kitchen","chair","bedroom","door"],correct:"kitchen",explanation:"La comida está en la cocina."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["bed","sofa","window","rice"],correct:"rice",explanation:"'Rice' no es mueble."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Bathroom' = baño",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Bathroom' significa baño."},
  {id:5,type:"ordering",question:"Ordena las letras: O S A F",options:["SOFA","FOAS","SAFO","OFAS"],correct:"SOFA",explanation:"Forma 'SOFA'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'We eat at the ___'",options:["table","bed","door","window"],correct:"table",explanation:"Comemos en la mesa."},
  {id:7,type:"multiple-choice",question:"Completa: 'I sleep in my ___'",options:["bed","chair","fridge","table"],correct:"bed",explanation:"Duermo en mi cama."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'kitcen'",options:["kitcen → kitchen","kitcen → kithen","kitcen → kichen","kitcen → kitchn"],correct:"kitcen → kitchen",explanation:"La forma correcta es 'kitchen'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'Open the ___'",options:["door","bed","table","chair"],correct:"door",explanation:"Abre la puerta."},
  {id:10,type:"multiple-choice",question:"Completa: 'There's a lamp in the ___'",options:["living room","rice","shoes","bread"],correct:"living room",explanation:"Hay una lámpara en la sala."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: bed ↔ ?",
    "options": [
      "cama",
      "mesa",
      "silla",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Bathroom” = baño",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: O S A F",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyBasicoLevel7Page() {
