...
const exercises = [
  {id:1,type:"matching",question:"Empareja: car ↔ ?",options:["🚗","🚲","✈️","🚂"],correct:"🚗",explanation:"'Car' es coche."},
  {id:2,type:"multiple-choice",question:"Completa: 'I go to school by ___'",options:["bus","bread","table","chair"],correct:"bus",explanation:"Voy al colegio en autobús."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["train","plane","bicycle","apple"],correct:"apple",explanation:"'Apple' no es transporte."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Bike' = bicicleta",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Bike' significa bicicleta."},
  {id:5,type:"ordering",question:"Ordena las letras: N A R T I",options:["TRAIN","TRANI","RATIN","NTRAI"],correct:"TRAIN",explanation:"Forma 'TRAIN'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'We fly in a ___'",options:["plane","car","bike","bus"],correct:"plane",explanation:"Volamos en un avión."},
  {id:7,type:"multiple-choice",question:"Completa: 'A ___ has two wheels.'",options:["bicycle","car","bus","train"],correct:"bicycle",explanation:"Una bicicleta tiene dos ruedas."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'plaine'",options:["plaine → plane","plaine → plain","plaine → plene","plaine → plan"],correct:"plaine → plane",explanation:"La forma correcta es 'plane'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'The ___ stops at the station.'",options:["train","plane","bicycle","car"],correct:"train",explanation:"El tren para en la estación."},
  {id:10,type:"multiple-choice",question:"Completa: 'I ride my ___ to work.'",options:["bike","train","plane","bread"],correct:"bike",explanation:"Voy en bici al trabajo."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: bank ↔ ?",
    "options": [
      "banco",
      "hospital",
      "parque",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Airport = aeropuerto",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: R A K P",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyIntermedioLevel1Page() {
