...
const exercises = [
  {id:1,type:"matching",question:"Empareja: teacher ↔ ?",options:["maestro","médico","conductor","cocinero"],correct:"maestro",explanation:"'Teacher' significa maestro."},
  {id:2,type:"multiple-choice",question:"Completa: 'The ___ helps sick people.'",options:["doctor","teacher","driver","cook"],correct:"doctor",explanation:"El doctor ayuda a personas enfermas."},
  {id:3,type:"odd-one-out",question:"¿Cuál NO pertenece al grupo?",options:["teacher","doctor","apple","nurse"],correct:"apple",explanation:"'Apple' no es profesión."},
  {id:4,type:"true-false",question:"Verdadero o falso: 'Cook' = cocinero",options:["Verdadero","Falso"],correct:"Verdadero",explanation:"'Cook' significa cocinero."},
  {id:5,type:"ordering",question:"Ordena las letras: E S R U N",options:["NURSE","NURES","UNSRE","SERUN"],correct:"NURSE",explanation:"Forma 'NURSE'."},
  {id:6,type:"multiple-choice",question:"Selecciona: 'A ___ drives a car.'",options:["driver","teacher","doctor","nurse"],correct:"driver",explanation:"Un conductor maneja un coche."},
  {id:7,type:"multiple-choice",question:"Completa: 'The ___ teaches students.'",options:["teacher","driver","cook","doctor"],correct:"teacher",explanation:"El maestro enseña a estudiantes."},
  {id:8,type:"error-correction",question:"Encuentra el error: 'docter'",options:["docter → doctor","docter → doktor","docter → doctir","docter → dotor"],correct:"docter → doctor",explanation:"La forma correcta es 'doctor'."},
  {id:9,type:"multiple-choice",question:"Selecciona: 'A ___ prepares food.'",options:["cook","teacher","driver","doctor"],correct:"cook",explanation:"Un cocinero prepara comida."},
  {id:10,type:"multiple-choice",question:"Completa: 'The ___ works at a hospital.'",options:["nurse","driver","cook","teacher"],correct:"nurse",explanation:"La enfermera trabaja en un hospital."}
];
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: bus ↔ ?",
    "options": [
      "🚌",
      "🚆",
      "🚗",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Ship = barco",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: N I A R T",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function A1VocabularyIntermedioLevel2Page() {
