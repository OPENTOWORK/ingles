...
export default function A1ReadingIntermedioLevel8Page() {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h1 style={{ color: "#2563eb", marginBottom: "0.5rem" }}>📖 Reading - Level 8</h1>
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/reading/intermedio/level-9"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
