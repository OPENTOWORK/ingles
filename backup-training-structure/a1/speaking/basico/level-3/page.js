...
const exercises = [
  {
    ...
    options: ["HEL-lo", "hel-LO", "HEL-LO", "hel-lo"],
    correct: "hel-LO",
    explanation: "'Hello' has stress on the second syllable: hel-LO."
  },
  {
    id: 2,
    type: "pronunciation",
    word: "Goodbye",
    phonetic: "/ɡʊdˈbaɪ/",
    question: "How do you pronounce 'Goodbye'?",
    options: ["GOOD-bye", "good-BYE", "GOOD-BYE", "good-bye"],
    correct: "good-BYE",
    explanation: "'Goodbye' has stress on the second syllable: good-BYE."
  },
  {
    id: 3,
    type: "pronunciation",
...
export default function A1SpeakingBasicoLevel3Page() {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h1 style={{ color: "#2563eb", marginBottom: "0.5rem" }}>🗣️ Speaking - Level 3</h1>
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/speaking/basico/level-4"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
