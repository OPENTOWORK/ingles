...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: intelligence ↔ ?",
    "options": [
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Data storage is the way we keep information digitally",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: G O L R I A T H M A",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function B2VocabularyAvanzadoLevel5Page() {
