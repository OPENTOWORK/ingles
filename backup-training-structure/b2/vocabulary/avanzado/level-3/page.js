...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: breakthrough ↔ ?",
    "options": [
      "avance",
      "hipótesis",
      "teoría",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “A hypothesis is an idea that needs to be tested",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: T H O E R Y",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function B2VocabularyAvanzadoLevel3Page() {
