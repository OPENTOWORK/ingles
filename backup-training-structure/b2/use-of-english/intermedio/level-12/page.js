...
export default function B2UseOfEnglishIntermedioLevel12Page() {
    ...
    <main style={{
      ...
      <div style={{
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/b2/use-of-english/intermedio/level-avanzado/level-1"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
        ...
        <div style={{ marginTop: "2rem" }}>
          <Link
            href="/training/b2/use-of-english/intermedio"
            style={{
