...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: entrepreneur ↔ ?",
    "options": [
      "emprendedor",
      "inversión",
      "ingresos",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Revenue is the total income a company makes",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: P E T E N R E U N R",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyBasicoLevel3Page() {
