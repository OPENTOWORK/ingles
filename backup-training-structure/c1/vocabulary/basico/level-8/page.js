...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: postgraduate ↔ ?",
    "options": [
      "posgrado",
      "titulación",
      "clase magistral",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “A postgraduate is someone who studies after obtaining a degree",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: S E H S I T",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyBasicoLevel8Page() {
