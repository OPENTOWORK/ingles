...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: biodiversity ↔ ?",
    "options": [
      "biodiversidad",
      "ecosistema",
      "contaminación",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Biodiversity means the variety of living species in an environment",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: T I O N A T N I M A C N O",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyIntermedioLevel4Page() {
