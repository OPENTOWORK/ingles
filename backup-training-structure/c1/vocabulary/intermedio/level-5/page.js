...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: biotechnology ↔ ?",
    "options": [
      "biotecnología",
      "encriptación",
      "interfaz",
    ...
    "correct": "biotecnología",
    "explanation": "'biotechnology'."
  },
  {
    "id": 2,
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Encryption protects data by converting it into code",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: Y G O L O H C E T O I B",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyIntermedioLevel5Page() {
