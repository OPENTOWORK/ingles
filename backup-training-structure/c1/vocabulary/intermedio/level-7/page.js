...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: jurisdiction ↔ ?",
    "options": [
      "jurisdicción",
      "litigio",
      "defensor",
      "violación (de ley o derecho)."
    ],
    "correct": "jurisdicción",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Litigation refers to the process of taking legal action",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: O C A V A T D E",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyIntermedioLevel7Page() {
