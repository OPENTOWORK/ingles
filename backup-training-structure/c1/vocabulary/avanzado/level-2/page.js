...
const exercises = [
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “A citation gives credit to the original author",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: T H D O M L O G E Y",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyAvanzadoLevel2Page() {
