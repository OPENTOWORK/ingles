...
const exercises = [
  ...
  },
  {
    "id": 5,
    "type": "true-false",
    "question": "Verdadero o falso: “Austerity means reducing public spending to save money",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 6,
    "type": "ordering",
    "question": "Ordena las letras: I B Y R I D V O T I E",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyAvanzadoLevel1Page() {
