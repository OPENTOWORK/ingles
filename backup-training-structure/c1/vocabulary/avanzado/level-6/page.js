...
const exercises = [
  {
    "id": 1,
    "type": "matching",
    "question": "Empareja: cybersecurity ↔ ?",
    "options": [
      "ciberseguridad",
      "cadena de bloques",
      "automatización",
  ...
  },
  {
    "id": 4,
    "type": "true-false",
    "question": "Verdadero o falso: “Automation replaces human work with machines or software",
    "options": [
      "Verdadero",
      "Falso"
    ],
  ...
  },
  {
    "id": 5,
    "type": "ordering",
    "question": "Ordena las letras: Y C T E U R I B S R E C",
    "options": [
      "WORD",
      "DROW",
      "ROWD",
...
export default function C1VocabularyAvanzadoLevel6Page() {
