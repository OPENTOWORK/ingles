...
Copia y pega el siguiente código SQL completo en el editor:
...
-- 6. Create adaptive learning data table
...
-- 9. Insert sample exercises data
...
-- Policies for adaptive learning data
...
CREATE TRIGGER update_adaptive_learning_updated_at BEFORE UPDATE ON adaptive_learning_data
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_user_preferences_updated_at BEFORE UPDATE ON user_preferences
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

-- 13. Create function to update user stats when progress is saved
...
1. **Copia todo el código SQL** de arriba
2. **Pégalo en el SQL Editor** de Supabase
3. **Haz clic en "Run"** o presiona Ctrl+Enter
4. **Espera** a que se ejecute completamente (puede tomar 30-60 segundos)

## Paso 4: Verificar la Configuración

Después de ejecutar el script, deberías ver:
- ✅ **7 tablas creadas** (exercises, user_progress, achievements, user_achievements, user_stats, adaptive_learning_data, user_preferences)
- ✅ **10 logros insertados**
- ✅ **5 ejercicios de ejemplo insertados**
...
2. **Haz clic en "Check Status"** en la interfaz de configuración
...
- Asegúrate de estar usando la cuenta **Owner** del proyecto Supabase
- Verifica que tienes permisos de administrador

### Error: "Table already exists"
- Es normal si ya ejecutaste el script antes
- El script usa `IF NOT EXISTS` para evitar conflictos
...
Una vez ejecutado el script, deberías poder:
1. ✅ Ver la página de onboarding
2. ✅ Completar el proceso de configuración inicial
3. ✅ Acceder a los ejercicios de training
4. ✅ Ver el dashboard de progreso
5. ✅ Recibir logros al completar ejercicios

¡Si todo funciona correctamente, tu sistema está 100% configurado y listo para usar! 🎉
