/**
 * Backup production B2 Exam 1 Part 13.
 * Usage: npx vercel env run --environment=production -- node scripts/backup-part13.mjs
 */
...
if (!parte?.id) {
  console.error('Parte 13 not found');
  process.exit(1);
}
...
const outPath = path.join(scriptsDir, 'generated', `backup-exam1-b2-part13-${Date.now()}.json`);
