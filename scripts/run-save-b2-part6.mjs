/**
 * Wrapper for Vercel env run (single entrypoint, no shell quoting issues).
 * Usage: npx vercel env run --environment=production -- node scripts/run-save-b2-part6.mjs
 */
...
const previewPath = path.join(scriptsDir, 'generated', 'preview-exam1-part6-b2.json');
...
console.error('Saving B2 Examen 1 Part 6 (Reading — Gapped Text)…');
