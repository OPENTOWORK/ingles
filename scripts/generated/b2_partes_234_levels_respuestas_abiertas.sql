...
-- B2 partes 2–3–4: respuestas abiertas desde Word (scripts/build-b2-partes-234-respuestas-abiertas.mjs)
...
WHERE ra.pregunta_id_abierta IN (
  ...
  AND pq.parte_id IN (
    'c7d425b7-63cf-4420-abdc-f38a28111259','1c4186d0-fdbe-41e7-8266-efdf712c3006','d02d4a2a-734c-4a46-8c7e-7b95734ee84d'
  )
);
