/**
 * POST approved Part 3 preview to production internal save endpoint.
 * Usage: npx vercel env run --environment=production -- node scripts/push-part3-to-production.mjs
 */
...
writeFileSync(path.join(scriptsDir, 'generated', 'save-part3-result.json'), JSON.stringify(out, null, 2));
