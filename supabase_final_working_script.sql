-- ========================================
-- SCRIPT FINAL FUNCIONANDO - BASADO EN TU SUPABASE REAL
-- ========================================
-- Este script usa los nombres EXACTOS de columnas que tienes
...
INSERT INTO public.logros (nombre, descripcion, categoria, icono, puntos_xp) VALUES
('Primer Paso', 'Completar tu primer ejercicio', 'progreso', '🎯', 10),
('Estudiante Dedicado', 'Completar 10 ejercicios en un día', 'dedicacion', '📚', 25),
('Velocidad Relámpago', 'Completar un ejercicio en menos de 30 segundos', 'velocidad', '⚡', 15),
('Consistencia Perfecta', 'Completar ejercicios 7 días seguidos', 'consistencia', '📅', 50),
('Maestro de Lectura', 'Obtener 90% en 10 ejercicios de reading', 'habilidad', '📖', 30),
('Escritor Experto', 'Obtener 90% en 10 ejercicios de writing', 'habilidad', '✍️', 30),
('Oído de Oro', 'Obtener 90% en 10 ejercicios de listening', 'habilidad', '🎧', 30),
('Conversador Natural', 'Obtener 90% en 10 ejercicios de speaking', 'habilidad', '🗣️', 30),
('Gramático Profesional', 'Obtener 90% en 10 ejercicios de use of english', 'habilidad', '📝', 30)
ON CONFLICT (nombre) DO NOTHING;

-- Insertar medios de ejemplo
INSERT INTO public.medios (nombre, tipo, url, descripcion, tamaño) VALUES
('imagen_ejemplo_1.jpg', 'imagen', '/media/images/ejemplo1.jpg', 'Imagen de ejemplo para ejercicios', 1024),
('audio_ejemplo_1.mp3', 'audio', '/media/audio/ejemplo1.mp3', 'Audio de ejemplo para listening', 2048),
('video_ejemplo_1.mp4', 'video', '/media/video/ejemplo1.mp4', 'Video de ejemplo para speaking', 5120)
ON CONFLICT DO NOTHING;

-- Insertar preguntas de ejemplo en banco
INSERT INTO public.banco_preguntas (enunciado, tipo, nivel, habilidad, puntos, explicacion) VALUES
('What is the capital of England?', 'multiple_choice', 'A2', 'reading', 1, 'London is the capital and largest city of England.'),
('Choose the correct form: "I _____ to school every day."', 'multiple_choice', 'A1', 'use_of_english', 1, 'The present simple tense uses the base form of the verb.'),
('Complete: "The weather is _____ today."', 'fill_blank', 'A2', 'use_of_english', 1, 'Adjectives describe the weather conditions.')
ON CONFLICT DO NOTHING;
...
-- Función para otorgar logros automáticamente
CREATE OR REPLACE FUNCTION public.otorgar_logro_automatico()
RETURNS TRIGGER AS $$
DECLARE
    logro_record RECORD;
BEGIN
    -- Buscar logros que el usuario pueda haber desbloqueado
    FOR logro_record IN 
        SELECT l.* FROM public.logros l
        WHERE l.id NOT IN (
            SELECT lu.logro_id FROM public.logros_usuario lu 
            WHERE lu.user_id = NEW.user_id
        )
    LOOP
        -- Aquí podrías agregar lógica específica para cada logro
        -- Por ahora, insertamos el logro básico si no existe
        INSERT INTO public.logros_usuario (user_id, logro_id, obtenido_en)
        VALUES (NEW.user_id, logro_record.id, NOW())
