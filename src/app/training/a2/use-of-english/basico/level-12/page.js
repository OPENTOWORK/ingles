...
export default function A2UseOfEnglishBasicoLevel12Page() {
    ...
    <main style={{
      ...
      <div style={{
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a2/use-of-english/basico/level-intermedio/level-1"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
        ...
        <div style={{ marginTop: "2rem" }}>
          <Link
            href="/training/a2/use-of-english/basico"
            style={{
