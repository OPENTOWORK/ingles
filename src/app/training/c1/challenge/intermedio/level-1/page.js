...
const exercises = [
  {
    id: 1,
    type: "comprehension",
    text: "This is a sample reading text for level 1. It contains information that students need to understand and answer questions about.",
...
export default function C1ChallengeIntermedioLevel1Page() {
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/c1/challenge/intermedio/level-2"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
