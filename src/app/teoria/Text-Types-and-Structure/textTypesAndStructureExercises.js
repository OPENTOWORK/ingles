...
export function buildTextTypesAndStructureExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('text-types-and-structure', config, level, primaryLevel);
}
