...
export function buildCohesionAndCoherenceExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('cohesion-and-coherence', config, level, primaryLevel);
}
