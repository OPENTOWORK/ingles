...
export function buildUsefulGrammarAndStructuresExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('useful-grammar-and-struc', config, level, primaryLevel);
}
