...
export function buildVocabularyByRegisterExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('vocabulary-by-register', config, level, primaryLevel);
}
