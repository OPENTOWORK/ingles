...
export function buildKeyResourcesToImproveExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('key-resources-to-improve', config, level, primaryLevel);
}
