...
export function buildCohesionAndConnectorsExercises(level = 'B2', primaryLevel = 'B2') {
  return buildTheoryExercises('cohesion-and-connectors', config, level, primaryLevel);
}
