...
const SECTIONS = {
  Grammar: [
    { text: "Articles, Determiners and Quantifiers", levels: ['A1'], href: "/teoria/1-Articles-Determiners-and-Quantifiers" },
    { text: "Verb \"to be\"", levels: ['A1'], href: "/teoria/2-Verb-to-be" },
    { text: "Pronouns", levels: ['A1'], href: "/teoria/3-Pronouns" },
    { text: "Adverbs and Adjectives", levels: ['A1','A2'], href: "/teoria/4-Adverbs-and-Adjectives" },
    { text: "Prepositions", levels: ['A1','A2'], href: "/teoria/5-Prepositions" },
    { text: "Word Formation", levels: ['B2'], href: "/teoria/6-Word-Formation" },
    { text: "Present Tenses", levels: ['A1','A2','B1'], href: "/teoria/7-Present-Tenses" },
    { text: "Past Tenses", levels: ['A2','B1','B2'], href: "/teoria/8-PastTenses" },
    { text: "Future Tenses", levels: ['A2','B1','B2'], href: "/teoria/9-Future-Tenses" },
    { text: "Infinitive vs Gerund", levels: ['B1'], href: "/teoria/10-Infinitive-vs-Gerund" },
    { text: "Sentence Structures", levels: ['A1','B1','B2'], href: "/teoria/11-Sentence-Structures" },
