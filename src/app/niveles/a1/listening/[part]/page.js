...
import { exercisesConfig, getExercise } from '@/data/exercises/a1-listening';
import { partInfo } from '@/data/part-info/a1-listening';
...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/a1' : `/niveles/a1/listening/${part - 1}`;
  const nextLink = part === 4 ? '/niveles/a1' : `/niveles/a1/listening/${part + 1}`;
