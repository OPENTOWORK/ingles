...
// ====== Página ======
export default function A1ExamHomePage() {
  const { answers } = useExam();

  return (
    <main className="shell exam-page">
      <header className="header">
        <h1>Cambridge A1 Exam Practice</h1>
        <p>Welcome to the A1 Cambridge English Exam Practice page.</p>
      </header>
      ...
      <div className="navigation">
        <Link href="/niveles/a1" className="back-link">
          ← Back to A1 Overview
        </Link>
      </div>
