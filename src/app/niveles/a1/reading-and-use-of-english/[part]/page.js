...
import { exercisesConfig, getExercise } from '@/data/exercises/a1-reading-and-use-of-english';
import { partInfo } from '@/data/part-info/a1-reading-and-use-of-english';
...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/a1' : `/niveles/a1/reading-and-use-of-english/${part - 1}`;
  const nextLink = part === 8 ? '/niveles/a1' : `/niveles/a1/reading-and-use-of-english/${part + 1}`;
  const homeLink = '/niveles/a1';
