...
export default function TheoryPage() {
  ...
  const backLink = part === 1 ? '/niveles/a1' : `/niveles/a1/reading-and-use-of-english/part-${part - 1}`;
  const nextLink = part === 8 ? '/niveles/a1' : `/niveles/a1/reading-and-use-of-english/part-${part + 1}`;
