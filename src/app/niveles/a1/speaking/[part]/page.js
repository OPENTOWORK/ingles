...
import { exercisesConfig, getExercise } from '@/data/exercises/a1-speaking';
import { partInfo } from '@/data/part-info/a1-speaking';
...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/a1' : `/niveles/a1/speaking/${part - 1}`;
  const nextLink = part === 4 ? '/niveles/a1' : `/niveles/a1/speaking/${part + 1}`;
