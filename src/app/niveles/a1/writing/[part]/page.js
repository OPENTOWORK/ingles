...
import { exercisesConfig, getExercise } from '@/data/exercises/a1-writing';
import { partInfo } from '@/data/part-info/a1-writing';
...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/a1' : `/niveles/a1/writing/${part - 1}`;
  const nextLink = part === 2 ? '/niveles/a1' : `/niveles/a1/writing/${part + 1}`;
