...
export default function B2SpeakingExamsPage() {
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'Segoe UI, sans-serif' }}>
      <h1 style={{ textAlign: 'center' }}>B2 Speaking Practice</h1>

      <section style={{ maxWidth: '800px', margin: '1.5rem auto', lineHeight: '1.6', color: '#333', textAlign: 'center' }}>
        <p>
          Choose one of the <strong>12 speaking exam sets</strong> to practice all four parts of the B2 Speaking test.
        </p>
      </section>
      ...
      <section style={{ maxWidth: '700px', margin: '2rem auto' }}>
        <div style={{
          ...
          {[...Array(12)].map((_, i) => (
            <Link
              key={i}
              href={`/niveles/b2/speaking/exam-${i + 1}/part-1`}
              style={buttonStyle}
