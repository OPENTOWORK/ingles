  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'Segoe UI, sans-serif' }}>
      ...
      <section style={{ maxWidth: '800px', margin: '1.5rem auto', lineHeight: '1.6', color: '#333', textAlign: 'center' }}>
        <p>
          Select from <strong>12 Reading exams</strong> based on authentic Cambridge B2 texts. Each exam includes all 4 reading parts.
        </p>
      </section>
      ...
      <section style={{ maxWidth: '700px', margin: '2rem auto' }}>
        <div style={{
          ...
          {[...Array(12)].map((_, i) => (
            <Link
              key={i}
              href={`/niveles/b2/reading/exam-${i + 1}/part-1`}
              style={buttonStyle}
