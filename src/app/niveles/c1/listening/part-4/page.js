...
export default function ListeningPart4() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      <h1>Listening – Part 4</h1>
      <p>This part involves multiple speakers on the same topic with matching tasks.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/listening/part-3"
          next="/niveles/c1/speaking/part-1"
          home="/niveles/c1"
        />
      </div>
    </div>
