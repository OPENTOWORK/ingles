...
export default function SpeakingPart1() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      <h1>Speaking – Part 1: General Conversation</h1>
      <p>The examiner asks general questions about yourself, such as hobbies, studies, work, or daily life.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/listening/part-4"
          next="/niveles/c1/speaking/part-2"
          home="/niveles/c1"
        />
      </div>
    </div>
