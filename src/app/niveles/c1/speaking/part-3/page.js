...
export default function SpeakingPart3() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p>You and your partner discuss a task and make a decision together.</p>
      ...
      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
        {exerciseComponents.map((_, i) => (
          <button
            ...
            style={{
              padding: '0.5rem 1rem',
              backgroundColor: selected === i ? '#F6AD55' : '#FEEBC8',
              border: 'none',
              borderRadius: '8px',
              fontWeight: 'bold',
              cursor: 'pointer'
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/speaking/part-2"
          next="/niveles/c1/speaking/part-4"
          home="/niveles/c1"
        />
      </div>
    </div>
