...
export default function UseOfEnglishExamsPage() {
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'Segoe UI, sans-serif' }}>
      <h1 style={{ textAlign: 'center' }}>C1 Use of English Practice</h1>

      <section style={{ maxWidth: '800px', margin: '1.5rem auto', lineHeight: '1.6', color: '#333', textAlign: 'center' }}>
        <p>
          Select from <strong>12 Use of English exams</strong>, each containing all 8 parts of the official Cambridge Advanced format.
        </p>
      </section>
      ...
      <section style={{ maxWidth: '700px', margin: '2rem auto' }}>
        <div style={{
          ...
          {[...Array(12)].map((_, i) => (
            <Link
              key={i}
              href={`/niveles/c1/reading-and-use-of-english/exam-${i + 1}/part-1`}
              style={buttonStyle}
