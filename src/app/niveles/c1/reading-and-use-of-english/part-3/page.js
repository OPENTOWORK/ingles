...
export default function ReadingPart3() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p>Complete the gaps in a text using the correct form of the word in brackets.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/reading-and-use-of-english/part-2"
          next="/niveles/c1/reading-and-use-of-english/part-4"
          home="/niveles/c1"
        />
      </div>
    </div>
