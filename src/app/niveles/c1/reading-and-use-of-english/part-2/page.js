...
export default function ReadingPart2() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p>You must complete a text by supplying a single word for each gap. No options are given.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/reading-and-use-of-english/part-1"
          next="/niveles/c1/reading-and-use-of-english/part-3"
          home="/niveles/c1"
        />
      </div>
    </div>
