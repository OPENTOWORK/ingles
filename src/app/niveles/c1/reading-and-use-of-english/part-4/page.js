...
export default function ReadingPart4() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p>Rewrite sentences using a given word, so that the meaning remains the same. Use between two and five words.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <NavigationButtons
          back="/niveles/c1/reading-and-use-of-english/part-3"
          next="/niveles/c1/reading-and-use-of-english/part-5"
          home="/niveles/c1"
        />
      </div>
    </div>
