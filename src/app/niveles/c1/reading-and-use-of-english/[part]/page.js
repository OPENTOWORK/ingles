...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/c1' : `/niveles/c1/reading-and-use-of-english/${part - 1}`;
  const nextLink = part === 8 ? '/niveles/c1' : `/niveles/c1/reading-and-use-of-english/${part + 1}`;
