    ...
    <div className="shell">
      ...
      <div className="exam-header">
        <div className="header">
          <h1>Part 15: Speaking - Photo description</h1>
        ...
        <div className="nav-buttons-grid">
          {Array.from({ length: 17 }, (_, i) => i + 1).map(partNum => (
            <Link 
              ...
              className={`nav-part-btn ${partNum === 15 ? 'current' : ''}`}
            >
              Part {partNum}
            </Link>
          ))}
      ...
      <div className="exam-navigation">
        <div className="nav-buttons">
          ...
          <Link href="/niveles/c1/exam-1/part-14" className="btn btn-secondary">
            ⬅ Previous
          </Link>
          <Link href="/niveles/c1/exam-1/part-16" className="btn btn-primary">
            Next ➡️
          </Link>
        </div>
      </div>
