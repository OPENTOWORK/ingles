...
const SECTIONS = {
  "Reading and Use of English": [
    { text: "Part 1: Multiple-choice cloze", href: "/niveles/c2/reading-and-use-of-english/part-1" },
    { text: "Part 2: Open cloze", href: "/niveles/c2/reading-and-use-of-english/part-2" },
    { text: "Part 3: Word formation", href: "/niveles/c2/reading-and-use-of-english/part-3" },
    { text: "Part 4: Key word transformations", href: "/niveles/c2/reading-and-use-of-english/part-4" },
    { text: "Part 5: Multiple-choice (reading)", href: "/niveles/c2/reading-and-use-of-english/part-5" },
    { text: "Part 6: Gapped text", href: "/niveles/c2/reading-and-use-of-english/part-6" },
    { text: "Part 7: Multiple matching", href: "/niveles/c2/reading-and-use-of-english/part-7" },
  ],
  "Writing": [
    { text: "Part 1: Compulsory task (240-280 words)", href: "/niveles/c2/writing/part-1" },
    { text: "Part 2: Choose from essay, letter, proposal, report, review (280-320 words)", href: "/niveles/c2/writing/part-2" },
  ],
  "Listening": [
    { text: "Part 1: Multiple choice (short extracts)", href: "/niveles/c2/listening/part-1" },
    { text: "Part 2: Sentence completion (monologue)", href: "/niveles/c2/listening/part-2" },
    { text: "Part 3: Multiple choice (conversation)", href: "/niveles/c2/listening/part-3" },
    { text: "Part 4: Multiple matching (short monologues)", href: "/niveles/c2/listening/part-4" },
  ],
  "Speaking": [
    { text: "Speaking Lab (AI) — Practice / Exam", href: "/niveles/speaking-lab/c2/" },
    { text: "Part 1: Interview", href: "/niveles/c2/speaking/part-1" },
    { text: "Part 2: Long turn", href: "/niveles/c2/speaking/part-2" },
    { text: "Part 3: Collaborative task and discussion", href: "/niveles/c2/speaking/part-3" },
  ],
};

const EXAM_LINKS = [
  { text: "📝 Full Exam", href: "/niveles/c2/exam-1" },
  { text: "📘 Use of English", href: "/niveles/c2/exam-useofenglish" },
  { text: "📖 Reading", href: "/niveles/c2/exam-reading" },
  { text: "✍️ Writing", href: "/niveles/c2/exam-writing" },
  { text: "🎧 Listening", href: "/niveles/c2/exam-listening" },
  { text: "🗣️ Speaking", href: "/niveles/c2/exam-speaking" },
];

// ====== Página ======
export default function C2Page() {
  return (
    <main className="shell c2-page">
      <header className="header">
        <h1>C2 Exam: Proficiency (CPE)</h1>
        <p>This is the highest level qualification that shows you have mastered English to an exceptional level.</p>
      </header>
