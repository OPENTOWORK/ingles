...
export default function TheoryPage() {
  ...
  const backLink = part === 1 ? '/niveles/c2' : `/niveles/c2/reading-and-use-of-english/part-${part - 1}`;
  const nextLink = part === 8 ? '/niveles/c2' : `/niveles/c2/reading-and-use-of-english/part-${part + 1}`;
