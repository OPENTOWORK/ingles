...
// ====== Página ======
export default function B1ExamHomePage() {
  const { answers } = useExam();

  return (
    <main className="shell exam-page">
      <header className="header">
        <h1>Cambridge B1 Exam Practice</h1>
        <p>Welcome to the B1 Cambridge English Exam Practice page.</p>
      </header>
      ...
      <div className="navigation">
        <Link href="/niveles/b1" className="back-link">
          ← Back to B1 Overview
        </Link>
      </div>
