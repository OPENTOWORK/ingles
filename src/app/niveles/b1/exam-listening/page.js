...
export default function ListeningExamPage() {
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'Segoe UI, sans-serif' }}>
      <h1 style={{ textAlign: 'center' }}>B1 Listening Practice</h1>

      <section style={{ maxWidth: '800px', margin: '1.5rem auto', lineHeight: '1.6', color: '#333', textAlign: 'center' }}>
        <p>
          Practice your <strong>Listening skills</strong> with exercises based on the official Cambridge B1 exam format.
        </p>
        <p>
      ...
      <section style={{ maxWidth: '700px', margin: '2rem auto' }}>
        <div style={{
          ...
          {[...Array(12)].map((_, i) => (
            <Link
              key={i}
              href={`/niveles/b1/listening/exam-${i + 1}/part-1`}
              style={buttonStyle}
