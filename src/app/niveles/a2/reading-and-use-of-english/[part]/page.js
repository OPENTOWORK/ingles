...
import { exercisesConfig, getExercise } from '@/data/exercises/a2-reading-and-use-of-english';
import { partInfo } from '@/data/part-info/a2-reading-and-use-of-english';
...
export default function DynamicPartPage() {
  ...
  const backLink = part === 1 ? '/niveles/a2' : `/niveles/a2/reading-and-use-of-english/${part - 1}`;
  const nextLink = part === 8 ? '/niveles/a2' : `/niveles/a2/reading-and-use-of-english/${part + 1}`;
