...
const SECTIONS = {
  "Reading and Writing": [
    { text: "Part 1: Matching (signs and messages)", href: "/niveles/a2/reading-and-use-of-english/part-1" },
    { text: "Part 2: Multiple choice (factual text)", href: "/niveles/a2/reading-and-use-of-english/part-2" },
    { text: "Part 3: Multiple choice (conversation)", href: "/niveles/a2/reading-and-use-of-english/part-3" },
    { text: "Part 4: Multiple choice (long text)", href: "/niveles/a2/reading-and-use-of-english/part-4" },
    { text: "Part 5: Multiple choice cloze", href: "/niveles/a2/reading-and-use-of-english/part-5" },
    { text: "Part 6: Writing a short message", href: "/niveles/a2/reading-and-use-of-english/part-6" },
    { text: "Part 7: Writing a short story", href: "/niveles/a2/reading-and-use-of-english/part-7" },
  ],
  "Listening": [
    { text: "Part 1: Multiple choice (pictures)", href: "/niveles/a2/listening/part-1" },
    { text: "Part 2: Matching (information)", href: "/niveles/a2/listening/part-2" },
    { text: "Part 3: Multiple choice (short dialogues)", href: "/niveles/a2/listening/part-3" },
...
const EXAM_LINKS = [
  { text: "📝 Full Exam", href: "/niveles/a2/exam-1" },
  { text: "📖 Reading & Writing", href: "/niveles/a2/exam-reading" },
  { text: "🎧 Listening", href: "/niveles/a2/exam-listening" },
  { text: "🗣️ Speaking", href: "/niveles/a2/exam-speaking" },
];

// ====== Página ======
export default function A2Page() {
  return (
    <main className="shell a2-page">
      <header className="header">
        <h1>A2 Exam: Key (KET)</h1>
        <p>This is a basic level qualification that shows you can use English to communicate in simple situations.</p>
      </header>
