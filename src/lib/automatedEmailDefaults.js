...
export const DEFAULT_AUTOMATED_EMAIL_TEMPLATES = [
  ...
  },
  {
    ...
    trigger_reason:
      'Se envía junto al correo de bienvenida para que el alumno confirme que el email es suyo.',
    asunto: 'Confirma tu email — Dralo English',
    cuerpo: [
      'Hola{{nombre}},',
      '',
      'Solo queda un paso: confirma que {{email}} es tu dirección de correo.',
      '',
      '{{action_url}}',
      '',
      'Al pulsar el botón entrarás directamente en tu cuenta. El enlace caduca en 24 horas y solo puede usarse una vez.',
      '',
