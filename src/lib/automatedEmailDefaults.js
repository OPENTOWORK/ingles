...
export const DEFAULT_AUTOMATED_EMAIL_TEMPLATES = [
  {
    ...
    trigger_reason:
      'Se envía la primera vez que el alumno entra con su email ya confirmado (registro con email o Google).',
    ...
    cuerpo: [
      ...
      '',
      'Con tu cuenta ({{email}}) podrás practicar reading, writing, listening, speaking y use of English por niveles A2–C2.',
      '',
      '{{login_url}}',
      '',
  ...
  {
    slug: 'staff_task_reminder',
    nombre: 'Recordatorio de tarea pendiente (staff)',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.STAFF_TASK_REMINDER,
    trigger_reason:
      'Se envía a la persona asignada cuando un administrador pulsa la campana de una tarea que sigue pendiente.',
    asunto: 'Recordatorio: tienes pendiente «{{task_titulo}}»',
    cuerpo: [
      'Hola{{nombre}},',
      '',
      '{{creator_name}} te recuerda que tienes esta tarea pendiente:',
      '',
      'Título: {{task_titulo}}',
      'Estado: {{task_estado}}',
      'Prioridad: {{task_prioridad}}',
  ...
  {
    slug: 'staff_task_message',
    nombre: 'Mensaje en chat de tarea',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.STAFF_TASK_MESSAGE,
    trigger_reason:
      'Se envía a los involucrados cuando hay un mensaje nuevo en la conversación de una tarea.',
    asunto: 'Nuevo mensaje en la tarea «{{task_titulo}}»',
    cuerpo: [
      'Hola{{nombre}},',
      '',
  ...
  },
  {
    ...
    trigger_reason:
      'Se envía a las inscripciones 2–50 de la campaña de lanzamiento con Plan Plus gratuito e indefinido, cuando confirman su email.',
  ...
  {
    slug: 'founding_member_survey',
    nombre: 'Encuesta founding — 30 días',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.FOUNDING_MEMBER_SURVEY,
    trigger_reason:
      'Se envía a los 30 días del alta a las inscripciones 2–50. Responder el formulario consolida el Plan Plus de por vida; no hacerlo en {{dias_plazo}} días lo retira.',
    asunto: 'Tu Plan Plus de por vida: solo te pedimos 3 minutos',
    cuerpo: [
      'Hola{{nombre}},',
      '',
  ...
  {
    slug: 'founding_member_survey_reminder',
    nombre: 'Encuesta founding — recordatorio',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.FOUNDING_MEMBER_SURVEY_REMINDER,
    trigger_reason:
      'Aviso cuando quedan pocos días para el cierre del formulario y el alumno aún no ha respondido.',
    asunto: 'Te quedan {{dias_restantes}} días para conservar tu Plan Plus',
    cuerpo: [
      'Hola{{nombre}},',
      '',
  ...
  {
    slug: 'founding_member_survey_confirmed',
    nombre: 'Encuesta founding — Plan Plus confirmado',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.FOUNDING_MEMBER_SURVEY_CONFIRMED,
    trigger_reason: 'Se envía al recibir las respuestas del formulario de los 30 días.',
    asunto: 'Hecho: tu Plan Plus es tuyo de por vida 🎉',
    cuerpo: [
      'Hola{{nombre}},',
      '',
  ...
  {
    slug: 'founding_member_survey_revoked',
    nombre: 'Encuesta founding — Plan Plus retirado',
    trigger_event: AUTOMATED_EMAIL_TRIGGERS.FOUNDING_MEMBER_SURVEY_REVOKED,
    trigger_reason:
      'Se envía cuando vence el plazo del formulario sin respuesta y la cuenta vuelve al Plan Free.',
    asunto: 'Tu Plan Plus de lanzamiento ha finalizado',
    cuerpo: [
      'Hola{{nombre}},',
      '',
