...
const PRESET_ROUTES = [
  ...
  { label: 'Perfil', path: '/perfil', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'Exam theory', path: '/niveles?tab=theory', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Hub exámenes', path: '/niveles/b2', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Modo examen', path: '/niveles/b2/exam-mode', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Reading', path: '/niveles/b2/exam-reading', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Writing', path: '/niveles/b2/exam-writing', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Listening', path: '/niveles/b2/exam-listening', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  { label: 'B2 — Speaking', path: '/niveles/b2/exam-speaking', roles: ['student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
  ...
  { label: 'Contacto', path: '/contacto', roles: ['guest', 'student', 'teacher', 'coordinator', 'support', 'informatico', 'admin'] },
