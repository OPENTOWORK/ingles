...
const PART1_QUESTIONS_BY_SLOT: Record<number, string[]> = {
  1: [
    'Let\'s begin. Do you work or are you a student at the moment?',
    'Can you tell me about the town or city where you live?',
    'What do you enjoy doing in your free time?',
    'How do people usually get around in your area — by car, public transport or something else?',
    'Is there anything new you would like to learn or achieve in the next few years?',
  ],
  2: [
    'Good morning. What are you studying, or what kind of work do you do?',
    'Where are you from originally, and where do you live now?',
    'How do you usually spend your weekends?',
    'Do you prefer reading online articles or watching videos to learn something new? Why?',
    'Would you like to live in another country one day? Why or why not?',
  ],
  3: [
    'First, tell me about your daily routine on a typical weekday.',
    'Do you live in a house or a flat? Which do you prefer and why?',
    'What kind of music, films or books do you like?',
    'When did you last go on a trip or holiday, and where did you go?',
    'Do you think technology has changed daily life? In what way?',
  ],
  4: [
    'Are you working full-time, part-time or preparing for exams at the moment?',
    'What is the best thing about the place where you live?',
    'What hobby would you recommend to a friend who wants to relax?',
    'How often do you use your phone or computer outside work or study?',
    'What are your plans for the next year or two?',
  ],
  5: [
    'To start, can you tell me about your job or main area of study?',
    'Where do you live at the moment, and what do you like about it?',
    'Who do you usually spend your free time with?',
    'Do you prefer doing sport indoors or outdoors? Why?',
    'Is there a skill you would like to improve? Which one and why?',
  ],
  6: [
    'Can you tell me your first name and whether you work or study?',
    'How has your hometown changed in recent years?',
    'What do you like to do when you have a free evening?',
    'Do you enjoy cooking, eating out or ordering food? Why?',
