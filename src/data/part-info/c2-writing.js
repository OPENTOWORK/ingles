...
const localPartInfo = {
  "1": {
    "title": "Part 1: Essay",
    "description": "You will write an essay (280-320 words) giving your opinion on a given topic. You need to present sophisticated arguments for and against the topic and give your own detailed opinion. This tests your ability to write a formal essay with clear structure and sophisticated language.",
  ...
  "2": {
    ...
    "description": "You will choose to write one of four different types of texts (280-320 words) based on a given situation. This tests your ability to write different types of texts with appropriate sophisticated language, structure, and register for different purposes and audiences.",
