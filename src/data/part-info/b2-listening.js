...
const localPartInfo = {
  "1": {
    ...
    "description": "You will hear eight short extracts from different situations (conversations, announcements, phone calls, etc.). For questions 1–8, choose the best answer (A, B or C). This tests your ability to understand the main points, specific information, and speakers' attitudes in short listening texts.",
  ...
  "2": {
    ...
    "description": "You will hear one radio-style interview (~5½–7 minutes in a single recording, played twice) and see ten incomplete sentences numbered 9–18. Complete each gap with 1–3 words taken literally from the recording. The sentences paraphrase what you hear — expect distractor vocabulary, phrasal verbs and collocations that make wrong words sound tempting.",
  ...
  "3": {
    ...
    "description": "You will hear five short monologues (~30–45 seconds each) from different speakers on the same general topic, in one recording (~8–10 minutes, played twice). For questions 19–23, match each speaker to one of eight options (A–H). Each letter is used once; three options are distractors. Expect phrasal verbs, collocations and overlapping ideas that make wrong options sound tempting.",
