...
const exercises = [
  {
    id: 1,
    type: "comprehension",
    text: "This is a sample reading text for level 2. It contains information that students need to understand and answer questions about.",
...
export default function C2ChallengeIntermedioLevel2Page() {
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/c2/challenge/intermedio/level-3"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
