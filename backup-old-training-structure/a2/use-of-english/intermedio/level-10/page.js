...
const exercises = [
  {
    id: 1,
    type: "comprehension",
    text: "This is a sample reading text for level 10. It contains information that students need to understand and answer questions about.",
...
export default function A2UseOfEnglishIntermedioLevel10Page() {
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a2/use-of-english/intermedio/level-11"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
