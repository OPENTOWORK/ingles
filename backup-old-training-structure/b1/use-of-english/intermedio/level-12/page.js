...
const exercises = [
  {
    id: 1,
    type: "comprehension",
    text: "This is a sample reading text for level 12. It contains information that students need to understand and answer questions about.",
...
export default function B1UseOfEnglishIntermedioLevel12Page() {
    ...
    <main style={{
      ...
      <div style={{
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/b1/use-of-english/intermedio/level-avanzado/level-1"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
        ...
        <div style={{ marginTop: "2rem" }}>
          <Link
            href="/training/b1/use-of-english/intermedio"
            style={{
