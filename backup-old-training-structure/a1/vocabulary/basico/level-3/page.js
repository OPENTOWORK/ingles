...
const exercises = [
  {
    ...
    correct: "Casa",
    explanation: "'House' means 'Casa' in Spanish - a building where people live."
  },
  {
    id: 2,
    type: "translation",
    ...
    options: ["Libro", "Casa", "Coche", "Árbol"],
    correct: "Libro",
    explanation: "'Book' means 'Libro' in Spanish - a written work with pages."
  },
  {
    id: 3,
    type: "translation",
    ...
    correct: "Agua",
    explanation: "'Water' means 'Agua' in Spanish - a clear liquid essential for life."
  },
  {
    id: 4,
    type: "translation",
    ...
    options: ["Comida", "Bebida", "Dulce", "Salado"],
    correct: "Comida",
    explanation: "'Food' means 'Comida' in Spanish - something that people eat."
  },
  {
    id: 5,
    type: "translation",
    ...
    options: ["Amigo", "Familia", "Vecino", "Compañero"],
    correct: "Amigo",
    explanation: "'Friend' means 'Amigo' in Spanish - a person you like and know well."
  }
];
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/vocabulary/basico/level-4"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
