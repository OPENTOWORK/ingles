...
const exercises = [
  {
    ...
    correct: "Hello",
    explanation: "The audio says 'Hello' - a common greeting in English."
  },
  {
    id: 2,
    skill: "reading",
    type: "comprehension",
    text: "My name is Maria. I am 20 years old. I live in Madrid. I like reading books.",
    question: "How old is Maria?",
    options: ["18", "20", "22", "25"],
    correct: "20",
    explanation: "The text clearly states 'I am 20 years old'."
  },
  {
    id: 3,
    skill: "vocabulary",
    ...
    correct: "Gato",
    explanation: "'Cat' means 'Gato' in Spanish - a domestic animal."
  },
  {
    id: 4,
    ...
    correct: "am",
    explanation: "Use 'am' with 'I' in the present tense."
  },
  {
    id: 5,
    skill: "writing",
...
export default function A1AllBasicoLevel1Page() {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h1 style={{ color: "#2563eb", marginBottom: "0.5rem" }}>🧩 All Skills - Level 1</h1>
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/all/basico/level-2"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
