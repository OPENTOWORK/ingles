...
const exercises = [
  ...
  },
  {
    ...
    type: "sentence_completion",
    prompt: "Complete the sentence:",
    sentence: "He _____ a teacher.",
    options: ["am", "is", "are", "be"],
    correct: "is",
    explanation: "Use 'is' with 'he' (third person singular)."
  },
  {
    id: 4,
    type: "sentence_completion",
  ...
  },
  {
    ...
    options: ["am", "is", "are", "be"],
    correct: "is",
    explanation: "Use 'is' with 'it' (third person singular)."
  }
];

export default function A1WritingBasicoLevel2Page() {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "2rem" }}>
          <h1 style={{ color: "#2563eb", marginBottom: "0.5rem" }}>✍️ Writing - Level 2</h1>
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/writing/basico/level-3"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
