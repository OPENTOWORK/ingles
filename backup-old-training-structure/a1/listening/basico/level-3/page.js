...
const exercises = [
  ...
  },
  {
    ...
    correct: "Hello",
    explanation: "The audio says 'Hello' - a common greeting."
  },
  {
    id: 3,
    type: "multiple_choice",
    ...
    correct: "Thank you",
    explanation: "The audio says 'Thank you' - an expression of gratitude."
  },
  {
    id: 4,
    type: "multiple_choice",
    ...
    correct: "Yes",
    explanation: "The audio says 'Yes' - an affirmative response."
  },
  {
    id: 5,
    type: "multiple_choice",
    audio: "https://www.soundjay.com/misc/sounds/bell-ringing-05.wav",
    question: "What do you hear?",
    options: ["Goodbye", "See you later", "Take care", "Have a good day"],
    correct: "Goodbye",
    explanation: "The audio says 'Goodbye' - a farewell expression."
  }
];

export default function A1ListeningBasicoLevel3Page() {
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/listening/basico/level-4"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
