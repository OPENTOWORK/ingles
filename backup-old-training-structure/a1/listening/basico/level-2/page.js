...
const exercises = [
  ...
  },
  {
    ...
    correct: "Book",
    explanation: "The audio says 'Book' - something you read."
  },
  {
    id: 3,
    type: "multiple_choice",
    ...
    correct: "Seven",
    explanation: "The audio says 'Seven' - the number 7."
  },
  {
    id: 4,
    type: "multiple_choice",
    audio: "https://www.soundjay.com/misc/sounds/bell-ringing-05.wav",
    question: "Listen to the color:",
    options: ["Red", "Blue", "Green", "Yellow"],
    correct: "Red",
    explanation: "The audio says 'Red' - a bright color."
  },
  {
    id: 5,
    type: "multiple_choice",
    audio: "https://www.soundjay.com/misc/sounds/bell-ringing-05.wav",
    question: "What food do you hear?",
    options: ["Bread", "Milk", "Water", "Coffee"],
    correct: "Bread",
    explanation: "The audio says 'Bread' - a common food."
  }
];

export default function A1ListeningBasicoLevel2Page() {
            ...
            <div style={{
              ...
              {currentExercise < exercises.length - 1 ? (
                ...
                <div style={{ marginTop: "1rem" }}>
                  ...
                  <Link
                    href="/training/a1/listening/basico/level-3"
                    style={{
                      backgroundColor: "#10b981",
                      color: "white",
                      border: "none",
